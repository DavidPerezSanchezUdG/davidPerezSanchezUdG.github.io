...
let Materials = {
    ...
    glass: new Material([0.05,0.05,0.075],[0.05,0.05,0.075],[50,50,75],1000,0.05,0.6),
...
let Scene = {
    ...
    Shapes: [
        new Plane("floor",[0,1,0],[0,0,0], Materials.yellow),
        new Sphere("chromeSphere1",[0,0.6,-3],0.6, Materials.chrome),
        new Sphere("chromeSphere2",[-1,2,-3],0.6, Materials.chrome),
        new Sphere("chromeSphere3",[1,2,-3],0.6, Materials.chrome),
        ...
        new Sphere("glassSphere",[0,0.3,-1.5],0.25, Materials.glass)
    ],
    Camera: {
        state: savedPois[0],
        front: [0,0,-1],
